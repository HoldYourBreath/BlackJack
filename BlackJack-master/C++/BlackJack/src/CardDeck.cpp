...
CardDeck::CardDeck()
{
    ...
    p_card_two_of_hearts->SetCardName("Two");
    ...
    p_card_three_of_hearts->SetCardName("Three");
    ...
    p_card_four_of_hearts->SetCardName("Four");
    ...
    p_card_five_of_hearts->SetCardName("Five");
    ...
    p_card_six_of_hearts->SetCardName("Six");
    ...
    p_card_seven_of_hearts->SetCardName("Seven");
    ...
    p_card_eight_of_hearts->SetCardName("Eight");
    ...
    p_card_nine_of_hearts->SetCardName("Nine");
    ...
    p_card_ten_of_hearts->SetCardName("Ten");
    ...
    p_card_three_of_spades->SetCardName("Three");
    ...
    p_card_four_of_spades->SetCardName("Four");
    ...
    p_card_five_of_spades->SetCardName("Five");
    ...
    p_card_six_of_spades->SetCardName("Six");
    ...
    p_card_seven_of_spades->SetCardName("Seven");
    ...
    p_card_eight_of_spades->SetCardName("Eight");
    ...
    p_card_nine_of_spades->SetCardName("Nine");
    ...
    p_card_ten_of_spades->SetCardName("Ten");
    ...
    p_card_three_of_clubs->SetCardName("Three");
    ...
    p_card_four_of_clubs->SetCardName("Four");
    ...
    p_card_five_of_clubs->SetCardName("Five");
    ...
    p_card_six_of_clubs->SetCardName("Six");
    ...
    p_card_seven_of_clubs->SetCardName("Seven");
    ...
    p_card_eight_of_clubs->SetCardName("Eight");
    ...
    p_card_nine_of_clubs->SetCardName("Nine");
    ...
    p_card_ten_of_clubs->SetCardName("Ten");
    ...
    p_card_ace_of_clubs->SetCardName("Ace");
    p_card_ace_of_clubs->SetCardValue(11);
    AddCard(p_card_ace_of_clubs);

    //Diamonds
    p_card_two_of_diamonds = new Card();
    p_card_two_of_diamonds->SetCardSuit("Diamonds");
    p_card_two_of_diamonds->SetCardName("Two");
    ...
    p_card_three_of_diamonds->SetCardName("Three");
    ...
    p_card_four_of_diamonds->SetCardName("Four");
    ...
    p_card_five_of_diamonds->SetCardName("Five");
    ...
    p_card_six_of_diamonds->SetCardName("Six");
    ...
    p_card_seven_of_diamonds->SetCardName("seven");
    ...
    p_card_eight_of_diamonds->SetCardName("Eight");
    ...
    p_card_nine_of_diamonds->SetCardName("Nine");
    ...
    p_card_ten_of_diamonds->SetCardName("Ten");
